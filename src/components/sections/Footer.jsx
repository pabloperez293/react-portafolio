        ...
        <AnimatePresence>
          {showButton && (
            <motion.button
              ...
              whileTap={{ scale: 0.96 }}
              className="inline-flex items-center gap-2 rounded-full border border-red-100 bg-red-600 px-4 py-2 text-white shadow-lg shadow-red-500/20 transition-all duration-300 hover:bg-red-700"
            >
